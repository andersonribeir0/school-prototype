...
func Show() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		var_2 := templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
			...
			err = components.Input("email", "email").Render(ctx, templBuffer)
			if err != nil {
				return err
			}
			if !templIsBuffer {
		...
		err = layout.Base().Render(templ.WithChildren(ctx, var_2), templBuffer)
		if err != nil {
			return err
		}
		if !templIsBuffer {
